...
export const project = {
  ...
  date: "2022-07-14",
  tags: ["Mobile development ", "Analytics", "Project idea"],
  technologies: ["Expo", "Hasura", "React native", "GraphQL", "TypeScript"],
  collaborators: ["Sebastian Yesid Pacheco"],
};
